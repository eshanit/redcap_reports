...
//
const postIntesectionArray = (selectedArray: any) => {
  router.get(`intersection/filtered/query`, selectedArray)
}
  ...
  {{ droppedIntersectionItems }}
      ...
      <div class="grid grid-cols-3 gap-5">
        ...
        <div id="union" class="p-5 bg-white rounded-lg">
          ...
          <div class="flex justify-end ">
            <div>
              <WarningOutlineButton @click="postIntesectionArray(droppedIntersectionItems)">
                Get Data
              </WarningOutlineButton>
            </div>
          </div>
